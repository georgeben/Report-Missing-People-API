const { newsletterService, emailService } = require('../services');
/**
...
async function addSubscription(req, res, next) {
  try {
    ...
    emailService.sendNewsletterAcknowledgementEmail(email);
...
async function updateSubscription(req, res, next) {
  ...
  try {
    ...
    // TODO: Send acknowledgement email to the new email address
    emailService.sendNewsletterAcknowledgementEmail(email);
